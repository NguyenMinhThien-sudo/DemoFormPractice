...
const Form = () => {
  ...
  const [selectForm2, setSelectForm2] = useState(true);
  const handleClickForm = () => {
    setSelectForm(!selectForm2);
    setSelectForm2(!selectForm);
  };
  return (
    <div>
      <AuthForm>
        <div className="main-form">
          <div className="form-wrapper">
            <div className="title-text">
              <div
                className={`title login-text ${
                  selectForm === !selectForm2 ? "is-active" : ""
                }`}
              >
                Đăng Nhập
              </div>
              ...
              <div className="slide-form">
                ...
                <label
                  ...
                  className={`slide login ${
                    selectForm ? "text-black" : "text-white"
                  }`}
